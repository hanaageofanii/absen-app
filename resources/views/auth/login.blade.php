...
<title>Login | Absensi & Laporan Karyawan</title>
...
Portal Absensi<br>
<span class="text-white/80 text-3xl">Karyawan Digital</span>
</h1>
<p class="text-white/90 text-lg leading-relaxed">
Sistem manajemen kehadiran modern untuk efisiensi maksimal
</p>
</div>
...
<div class="absolute left-4 top-1/2 -translate-y-1/2 opacity-0 peer-focus:opacity-100">
...
<!-- Register Button -->
<div class="mt-4 text-center animate-in" style="animation-delay:0.65s">
    <a href="/register"
       class="inline-block py-3 px-6 rounded-2xl text-indigo-600 border-2 border-indigo-600 font-semibold hover:bg-indigo-600 hover:text-white transition-all">
       Belum punya akun? Daftar
    </a>
</div>

<!-- Footer -->
<div class="mt-10 text-center animate-in" style="animation-delay:0.7s">
...
© {{ date('Y') }} Cikarang Property - Secure System
</p>
</div>
